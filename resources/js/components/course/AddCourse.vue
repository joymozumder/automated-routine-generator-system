                                ...
                                <div class="p-3">
                                    <form class="w-full">
                                        <div class="md:flex md:items-center mb-6">
                                            ...
                                            <div class="md:w-3/4">
                                                <input class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                                    id="inline-full-name" type="text" v-model="course.code" placeholder="Enter Course Code">
                                            </div>
                                        </div>
                                        ...
                                        <div class="md:flex md:items-center mb-6">
                                            ...
                                            <div class="md:w-3/4">
                                                <input class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                                    id="inline-full-name" type="text" v-model="course.name" placeholder="Enter Course Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="md:flex md:items-center mb-6">
                                            ...
                                            <div class="md:w-3/4 relative">
                                                <select class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                                     v-model="course.semester"    id="grid-state">
